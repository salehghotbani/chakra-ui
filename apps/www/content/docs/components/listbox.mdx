...
Use the `highlightFirst`, `highlightLast`, `highlightNext`, and
`highlightPrevious` methods from the listbox store to move the highlighted item
programmatically.

<ExampleTabs name="listbox-with-highlight-controls" />
